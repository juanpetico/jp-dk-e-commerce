    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            <div className="bg-card dark:bg-card border border-gray-300 dark:border-border p-6 rounded-xl shadow-sm flex flex-col justify-between h-32 relative overflow-hidden">
                ...
                <h3 className="font-display text-2xl font-bold leading-none text-foreground h-8 flex items-center">{formatPrice(analytics.totalSales)}</h3>
                <div className="text-xs text-green-600 dark:text-green-400 font-bold z-10 flex items-center gap-1 pt-1">
            ...
            <div className="bg-card dark:bg-card border border-gray-300 dark:border-border p-6 rounded-xl shadow-sm flex flex-col justify-between h-32">
                ...
                <h3 className="font-display text-2xl font-bold leading-none text-foreground h-8 flex items-center">{analytics.pendingOrders}</h3>
                <div className="text-xs text-muted-foreground pt-1">Estado pendiente por gestionar</div>
            </div>
            ...
            <div className="bg-card dark:bg-card border border-gray-300 dark:border-border p-6 rounded-xl shadow-sm flex flex-col justify-between h-32">
                ...
                <div className="flex items-center justify-between gap-3 w-full h-8">
                    <h3 className="font-display text-2xl font-bold leading-none text-foreground">{attributedRevenueRateLabel}</h3>
            ...
            <div className="bg-card dark:bg-card border border-gray-300 dark:border-border p-6 rounded-xl shadow-sm flex flex-col justify-between h-32 relative">
                ...
                <h3 className="font-display text-2xl font-bold leading-none text-foreground h-8 flex items-center">{abandonedRateLabel}</h3>
                <div className="text-xs font-medium text-muted-foreground tracking-wider pt-1">
            ...
            <div className="bg-card dark:bg-card border border-amber-900 dark:border-amber-900/30 p-6 rounded-xl shadow-sm flex flex-col justify-between h-32 relative">
                ...
                <h3 className="font-display text-2xl font-bold leading-none text-amber-900 dark:text-amber-400 h-8 flex items-center">{analytics.lowStockCount}</h3>
                <div className="text-xs text-amber-700 dark:text-amber-600 font-medium pt-1">
