    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {coupons.map((item) => (
                ...
                >
                    <div className="absolute top-1/2 -left-3 w-6 h-6 bg-background rounded-full border border-border -translate-y-1/2" />
                    <div className="absolute top-1/2 -right-3 w-6 h-6 bg-background rounded-full border border-border -translate-y-1/2" />
